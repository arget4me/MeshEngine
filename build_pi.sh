...
SOURCE_PATH=src
SOURCE_FILES=$SOURCE_PATH/RaspberryPi/raspberrypi_platform_layer.cpp
...
g++ $DEFINED_MACROS $INCLUDE_DIRECTORIES -g $SOURCE_FILES -o $BUILD_PATH/$EXECUTABLE_NAME_DEBUG $LINK_LIBRARIES
echo $EXECUTABLE_NAME_DEBUG 'build complete!'
echo ...

echo 'building' $EXECUTABLE_NAME_RELEASE
g++ $DEFINED_MACROS $INCLUDE_DIRECTORIES $SOURCE_FILES -O3 -o $BUILD_PATH/$EXECUTABLE_NAME_RELEASE $LINK_LIBRARIES
